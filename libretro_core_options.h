...
struct retro_core_option_definition option_defs_us[] = {
   ...
   {
      BEETLE_OPT(voices_volume),
      "Hardware Voices Volume",
      "Changes playback volume of hardware voices. May cause clipping/saturation if set too high. Leave at default if unsure.",
      {
         { "0%",   NULL },
         { "10%",  NULL },
         { "20%",  NULL },
   ...
   {
      BEETLE_OPT(cdda_volume),
      "CDDA Volume",
      "Changes playback volume of CD audio. May cause clipping/saturation if set too high. Leave at default if unsure.",
      {
         { "0%",   NULL },
         { "10%",  NULL },
         { "20%",  NULL },
