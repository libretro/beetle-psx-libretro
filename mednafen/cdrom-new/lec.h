 ...
 */
void lec_encode_mode0_sector(int32_t adr, int8_t *sector);
 ...
 * offset 16
 */
void lec_encode_mode1_sector(int32_t adr, int8_t *sector);
 ...
 * offset 16
 */
void lec_encode_mode2_sector(int32_t adr, int8_t *sector);
 ...
 * offset 16
 */
void lec_encode_mode2_form1_sector(int32_t adr, int8_t *sector);
 ...
 * offset 16
 */
void lec_encode_mode2_form2_sector(int32_t adr, int8_t *sector);
