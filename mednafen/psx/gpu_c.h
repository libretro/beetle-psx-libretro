 ...
 * API that dma.c needs. The full gpu.h pulls in math.h, git.h,
 * and (transitively) video/surface.h - all now plain C - plus a
 * heavy PS_GPU struct definition that dma doesn't need any of.
 *
