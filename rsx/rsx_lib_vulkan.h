#ifndef __RSX_VULKAN_H__
#define __RSX_VULKAN_H__
...
void rsx_vulkan_set_environment(retro_environment_t);
void rsx_vulkan_set_video_refresh(retro_video_refresh_t);
void rsx_vulkan_get_system_av_info(struct retro_system_av_info *);
...
void rsx_vulkan_set_draw_area(uint16_t x, uint16_t y,
